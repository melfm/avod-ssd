...
import avod.protos.mini_batch_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[avod.protos.mini_batch_pb2.DESCRIPTOR,])
...
_KITTIUTILSCONFIG.fields_by_name['mini_batch_config'].message_type = avod.protos.mini_batch_pb2._MINIBATCHCONFIG
