...
def build(model, prediction_dict):
    ...
    model_type = model._config.model_type.WhichOneof('model_type')
    model_config = model._config.model_type

    if model_type == 'avod':
        avod_box_rep = model_config.avod.avod_config.avod_box_representation
    elif model_type == 'avod_ssd':
        avod_box_rep = model_config.avod_ssd.avod_config.avod_box_representation
...
def _get_cls_loss(model, cls_logits, cls_gt):
    ...
    model_name = model._config.model_name
    ...
    if model_name == 'avod_model':
        ...
        cls_fl_gamma = model._config.loss_config.cls_fl_gamma
        cls_fl_alpha = model._config.loss_config.cls_fl_alpha
