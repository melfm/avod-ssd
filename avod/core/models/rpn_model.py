...
class RpnModel(model.DetectionModel):
    ...
    def __init__(self, model_config, train_val_test, dataset):
        ...
        # Rpn config
        model_type = self._config.model_type.WhichOneof('model_type')
        model_config = self._config.model_type
        if model_type == 'rpn':
            rpn_config = model_config.rpn.rpn_config
        elif model_type == 'avod':
            rpn_config = model_config.avod.rpn_config
